      ...
      <div className="max-w-6xl mx-auto px-6 py-8 grid md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div className="flex space-x-4 mt-4">
            {/* YouTube */}
            <a href="https://www.youtube.com/@concordmachinetools" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/concordmachinetools/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/company/concord-machine-tools/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            ...
            {/* Facebook */}
            <a href="https://www.facebook.com/concordmachinetools/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
