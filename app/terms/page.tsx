...
export const metadata: Metadata = {
  ...
  description: 'Read the machine sale terms and conditions for purchasing used metalworking equipment from Concord Machine Tools.',
  alternates: {
    canonical: '/terms',
  },
  openGraph: {
    title: 'Terms & Conditions | Concord Machine Tools',
    description: 'View the terms and conditions for buying used CNC and metalworking machinery from Concord Machine Tools.',
    type: 'website',
  },
};
